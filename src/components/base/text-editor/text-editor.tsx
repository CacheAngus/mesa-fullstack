...
const TextEditorRoot = ({
        ...
        editorProps: {
            attributes: {
                ...
                class: cx(
                    ...
                    isInvalid &&
                        "ring-error_subtle focus:ring-2 focus:ring-error",
                    inputClassName
                ),
            },
        },
    ...
    return (
        <EditorContext.Provider
            value={{ editor, isDisabled, limit, isInvalid, editorId }}
        >
...
const TextEditorHintText = ({
    children,
    ...props
}: TextEditorHintTextProps) => {
    ...
    return (
        ...
        >
            {children ||
                `${charactersLeft.toLocaleString()} character${
                    charactersLeft === 1 ? "" : "s"
                } left`}
        </HintText>
    );
