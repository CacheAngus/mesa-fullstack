...
export const sm = ({
    ...
    return (
        <div
            {...otherProps}
            className={cx("relative h-30 w-40.25", className)}
        >
            <svg
                viewBox="0 0 161 120"
                fill="none"
...
export const md = ({
    ...
    return (
        <div
            {...otherProps}
            className={cx("relative h-34.25 w-46.25", className)}
        >
            <svg
                viewBox="0 0 185 137"
                fill="none"
...
export const lg = ({
    ...
    return (
        <div
            {...otherProps}
            className={cx("relative h-41.5 w-57.5", className)}
        >
            <svg
                viewBox="0 0 230 166"
                fill="none"
