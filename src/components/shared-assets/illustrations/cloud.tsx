...
export const sm = ({
    ...
    return (
        <div
            {...otherProps}
            className={cx("relative h-30 w-38", className)}
        >
            <svg
                viewBox="0 0 152 120"
                fill="none"
                className={cx(
                    "size-full stroke-inherit text-inherit",
                    svgClassName
                )}
            >
                <circle
...
export const md = ({
    ...
    return (
        <div
            {...otherProps}
            className={cx("relative h-32 w-43", className)}
        >
            <svg
                viewBox="0 0 182 137"
                fill="none"
            ...
            >
                ...
                <g filter="url(#filter-01-md)">
                    ...
                    <circle
                        ...
                        cy="64"
                        r="32"
                        fill="url(#cloud-gradient-01-md)"
                    />
                    <circle
                        cx="93"
                        cy="56"
                        r="40"
                        fill="url(#cloud-gradient-02-md)"
                    />
                    <circle
                        cx="133"
                        cy="68"
                        r="28"
                        fill="url(#cloud-gradient-03-md)"
                    />
                </g>
...
export const lg = ({
    ...
    return (
        <div
            {...otherProps}
            className={cx("relative h-40 w-55", className)}
        >
            <svg
                viewBox="0 0 220 160"
                fill="none"
