...
export const SidebarNavigationSimple = ({
    ...
    const content = (
        ...
        >
            ...
            <div className="mt-auto flex flex-col gap-4 px-2 py-4 lg:px-4 font-display-light lg:py-6">
                ...
                {showAccountCard && <NavAccountCard item={user} />}
            </div>
        </aside>
    );
