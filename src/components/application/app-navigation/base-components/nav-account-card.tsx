...
export const NavAccountCard = ({
    ...
    return (
        <div className="relative flex items-center font-body gap-3 rounded-xl p-3 ring-1 ring-secondary ring-inset">
            <figure className={cx("group flex min-w-0 flex-1 items-center")}>
                <figcaption className="min-w-0 flex-1">
                    <div className="flex flex-row gap-1">
                        {" "}
                        <p className="text-black">{item.first_name}</p>
                        <p className="text-black">{item.last_name}</p>
                    </div>
                    <p className={cx("truncate text-tertiary")}>{item.email}</p>
                </figcaption>
            </figure>
        </div>
    );
