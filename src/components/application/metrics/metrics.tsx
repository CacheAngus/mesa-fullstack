...
export const MetricChangeIndicator = ({
    type,
    trend,
    value,
    className,
        ...
        >
            <div className="relative flex flex-col gap-2 px-4 py-5 md:px-5">
                ...
                <div className="flex items-end gap-4">
                    <p className="flex-1 text-display-sm font-semibold text-primary">
                        {title}
                    </p>
...
const CustomizedDot = (
    props: DotProps & { payload?: { highlight?: boolean }; dotColor?: string }
) => {
...
export const MetricsChart04 = ({
    ...
    return (
        ...
        >
            ...
            {footer && (
                <div className="flex items-center justify-end py-3 pr-4 pl-3 md:pr-5 md:pl-4">
                    {footer}
                </div>
            )}
        </div>
